...
- [x] tick 19: Replay digest matched expected deterministic digest
...
```json
{
  ...
  "sensors": {
    ...
    "link_ok": true,
    "pressure_kpa": 98.8,
    "temperature_c": 60.583400000000005,
    "valid": true
  },
  "state": "OFF",
